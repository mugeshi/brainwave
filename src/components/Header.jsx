...
function Header() {
  return (
    ...
    lg:backdrop-blur-sm"
    >
      <div className="flex items-centre px-5 lg:px-7.5 xl:px-10 max-lg-4">
        ...
        bg-n-8 lg:static lg:flex lg:mx-auto lg:bg-transparent" >
            <div className="relative z-2 flex flex-col items-centre 
            jeustify-centre m-auto lg:flex-row">
              1 2 3
